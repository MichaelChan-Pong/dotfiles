...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="mcp-theme"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/mcp/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/mcp/.mailcheckrc"
# }
